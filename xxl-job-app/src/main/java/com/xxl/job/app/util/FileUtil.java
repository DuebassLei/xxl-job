...
public class FileUtil {
	...
	public static void writeFile(String fileName, String content, String charset) {
		try(Writer out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(fileName), charset));) {
	 ...
	 * 
	 * @return 
	 *         返回如下的路径E:/work/x5/x5-base-root/modules/x5-base-core/target/classes
	 *         。
